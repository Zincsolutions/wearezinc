...
const TITLE = "Branding & Positioning Services | ZINC";
const DESCRIPTION = "Brand strategy, identity, and positioning that sharpen how customers \u2014 and AI engines \u2014 understand and choose you.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/solutions/branding-positioning" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function SolutionsBrandingPositioningPage() {
  return (
    <div className="site">
