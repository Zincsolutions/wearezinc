...
const TITLE = "AI Enablement Services | Strategy, Prototyping & Workflows | ZINC";
const DESCRIPTION = "ZINC helps brands adopt AI with strategy, readiness workshops, rapid prototyping, brand image libraries, and scalable marketing workflows.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/solutions/ai-enablement" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function SolutionsAiEnablementPage() {
  return (
    <div className="site">
