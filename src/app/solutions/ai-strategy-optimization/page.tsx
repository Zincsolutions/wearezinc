...
const TITLE = "AEO Answer Engine Optimization Agency";
const DESCRIPTION = "Get recommended by AI with proven AEO strategy. ZINC helps brands show up accurately in ChatGPT, Perplexity & AI search through structured optimization.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/solutions/ai-strategy-optimization" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function SolutionsAiStrategyOptimizationPage() {
  return (
    <div className="site">
