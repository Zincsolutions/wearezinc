...
const TITLE = "Content & Campaign Systems | ZINC";
const DESCRIPTION = "Repeatable content and campaign systems: on-brand assets, faster production, and AI-assisted workflows your team can actually run.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/solutions/content-campaign-systems" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function SolutionsContentCampaignSystemsPage() {
  return (
    <div className="site">
