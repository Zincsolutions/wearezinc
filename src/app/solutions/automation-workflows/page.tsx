...
const TITLE = "AI Automation & Workflow Services | ZINC";
const DESCRIPTION = "Design and implement AI-powered automations and marketing workflows that cut busywork and scale output without scaling headcount.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/solutions/automation-workflows" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function SolutionsAutomationWorkflowsPage() {
  return (
    <div className="site">
