...
const TITLE = "AI Dispatch | Centralize Your AI Operations | ZINC";
const DESCRIPTION = "Centralize your AI strategy with Dispatch. Organize prompts, workflows, image libraries, and documentation into one scalable system for your team.";
...
export default function SolutionsAiDispatchPage() {
  return (
    <div className="site">
