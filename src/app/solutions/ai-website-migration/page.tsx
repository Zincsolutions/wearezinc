...
const TITLE = "AI Website Migration | Move Beyond Your CMS, Keep Your Site | ZINC";
const DESCRIPTION =
  "ZINC moves company websites off WordPress and other CMS platforms onto an AI-native stack, pixel for pixel, and connects them to Dispatch so your team can run the site with its own AI agent, every change previewed, approved, and reversible.";
