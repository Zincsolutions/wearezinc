...
const TITLE = "Navigator Global Case Study | Website & Brand | ZINC";
const DESCRIPTION = "How ZINC partnered with Navigator Global on brand and web experience. See the work.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work/navigator-global" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function WorkNavigatorGlobalPage() {
  return (
    <div className="site">
