...
const TITLE = "Our Work | AI, Web & Brand Case Studies | ZINC";
const DESCRIPTION = "Explore ZINC case studies across private equity, ecommerce, healthcare, and consumer brands \u2014 strategy, design, and AI-driven results.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
