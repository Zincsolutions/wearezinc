...
const TITLE = "Growth99 Case Study | Web & Brand | ZINC";
const DESCRIPTION = "How ZINC partnered with Growth99 on digital design and brand. See the work.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work/growth99" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function WorkGrowth99Page() {
  return (
    <div className="site">
