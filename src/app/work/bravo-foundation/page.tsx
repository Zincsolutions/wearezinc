...
const TITLE = "Bravo Family Foundation Case Study | ZINC";
const DESCRIPTION = "How ZINC supported the Bravo Family Foundation's digital presence and storytelling. See the work.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work/bravo-foundation" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function WorkBravoFoundationPage() {
  return (
    <div className="site">
