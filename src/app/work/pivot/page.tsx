...
const TITLE = "Pivot Case Study | Brand & Digital | ZINC";
const DESCRIPTION = "How ZINC partnered with Pivot on brand and digital experience. See the work.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work/pivot" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function WorkPivotPage() {
  return (
    <div className="site">
