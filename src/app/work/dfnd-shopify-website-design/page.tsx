...
const TITLE = "DFND Shopify Case Study | Ecommerce Website Design | ZINC";
const DESCRIPTION = "ZINC partnered with DFND to design a custom Shopify website and support ecommerce growth through UX, Klaviyo, and Amazon channel expansion.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/work/dfnd-shopify-website-design" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function WorkDfndShopifyWebsiteDesignPage() {
  return (
    <div className="site">
