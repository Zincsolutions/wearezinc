...
const TITLE = "Shopify Partner | Ecommerce Design & Growth | ZINC";
const DESCRIPTION = "As a Shopify partner, ZINC designs, builds, and optimizes storefronts that convert \u2014 from UX and theme builds to AI-ready product content.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/partners/shopify" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function PartnersShopifyPage() {
  return (
    <div className="site">
