...
const TITLE = "Webflow Partner | Site Design & Development | ZINC";
const DESCRIPTION = "ZINC designs and develops fast, flexible marketing sites on Webflow \u2014 built to rank in classic search and AI answers alike.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/partners/webflow" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function PartnersWebflowPage() {
  return (
    <div className="site">
