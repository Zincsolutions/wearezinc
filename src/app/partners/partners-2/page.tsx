...
const TITLE = "Partners | Webflow, Shopify & Tech Alliances | ZINC";
const DESCRIPTION = "ZINC partners with Webflow, Shopify, and leading platforms to design, build, and grow high-performing digital experiences.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/partners/partners-2" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function PartnersPartners2Page() {
  return (
    <div className="site">
