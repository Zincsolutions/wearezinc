...
const TITLE = "Careers at ZINC | Join an AI-Native Creative Team";
const DESCRIPTION = "Work at the intersection of strategy, design, and AI. See open roles and tell us how you'd make ZINC better.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/careers" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
