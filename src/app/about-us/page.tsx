...
const TITLE = "About ZINC | AI-Driven Strategy & Design Agency";
const DESCRIPTION = "Meet ZINC: 25+ years of brand, web, and ecommerce expertise, now helping companies adopt AI across strategy, design, and marketing operations.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/about-us" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function AboutUsPage() {
  return (
    <div className="site">
      ...
      <Script src="/js/about-words.js" strategy="afterInteractive" />
