...
const TITLE = "Privacy Policy | ZINC";
const DESCRIPTION = "How ZINC collects, uses, and protects your information.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/about/privacy-policy" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function AboutPrivacyPolicyPage() {
  return (
    <div className="site">
