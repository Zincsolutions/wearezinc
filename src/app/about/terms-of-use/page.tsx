...
const TITLE = "Terms of Use | ZINC";
const DESCRIPTION = "Review the terms and conditions that govern use of the ZINC website, services information, content, and digital resources.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: "https://www.wearezinc.com/about/terms-of-use" },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    type: "website",
...
export default function AboutTermsOfUsePage() {
  return (
    <div className="site">
